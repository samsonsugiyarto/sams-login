...
class Auth extends CI_Controller
{
    ...
    public function registration()
    {
        ...
        $data['title'] = 'SAMS User Registration';
    ...
    public function verify()
    {
        ...
        $user = $this->Auth->getUserEmail($email);

        if ($user) {
            $user_token = $this->Auth->getUserToken($token);
            if ($user_token) {
                if (time() - $user_token['date_created'] < (60 * 60 * 24)) {
                    $this->Auth->updateUser($email);
    ...
    public function forgotPassword()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $email = $this->input->post('email');
            $user = $this->Auth->getUserByEmailandIs_active($email);
    ...
    public function changePassword()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->Auth->updatePassword($password, $email);
